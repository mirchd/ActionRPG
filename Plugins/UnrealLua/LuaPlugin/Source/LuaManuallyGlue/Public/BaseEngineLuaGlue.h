...
LUA_GLUE_OVERLOAD(LoadFileToString, void (FFileHelper::*)(FString&, FArchive&, EHashOptions))
LUA_GLUE_OVERLOAD(LoadFileToString, void (FFileHelper::*)(FString&, const TCHAR*, EHashOptions, uint32))
