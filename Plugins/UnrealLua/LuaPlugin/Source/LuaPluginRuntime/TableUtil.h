...
public:
	...
	static TMap<UClass*, TFunction<void(lua_State*, FProperty*, const void*)> > PropertyClassToPushFuncMap;
	static TMap<UClass*, TFunction<void(lua_State*, int, FProperty*, void*)> > PropertyClassToPopFuncMap;
